...
List<Planet> planets = <Planet>[
  Planet(
    ...
    imgAssetPath: Assets.imagesMercury1,
    vidAssetPath: Assets.assetsThreedMercury,
  ),
  Planet(
    imgBack: Assets.threedVenus,
    name: 'Venus',
    ...
    imgAssetPath: Assets.imagesVenus1,
    vidAssetPath: Assets.assetsThreedVenus,
  ),
  Planet(
    imgBack: Assets.threedEarth,
    name: 'Earth',
    color: Colors.blue,
    moons: [
      Moon(
        imgBack: Assets.threedMoon,
        name: 'Moon',
        description:
        ...
        imgAssetPath: Assets.imagesMoon,
        vidAssetPath: Assets.assetsThreedMoon,
      )
    ],
    diameter: 1.0,
    description:
    ...
    imgAssetPath: Assets.imagesEarth,
    vidAssetPath: Assets.assetsThreedEarth,
  ),
  Planet(
    imgBack: Assets.threedMars,
    name: 'Mars',
    moons: [
      Moon(
        imgBack: Assets.threedDeimos,
        name: 'Deimos',
        description:
        ...
        imgAssetPath: Assets.imagesDeimos,
        vidAssetPath: Assets.assetsThreedDeimos,
      ),
      Moon(
        imgBack: Assets.threedPhobos,
        name: 'Phobos',
        description:
        ...
        imgAssetPath: Assets.imagesPhobos,
        vidAssetPath: Assets.assetsThreedPhobos,
      )
    ],
    color: Colors.red,
    diameter: 0.532,
    ...
    imgAssetPath: Assets.imagesMars,
    vidAssetPath: Assets.assetsThreedMars,
  ),
  Planet(
    imgBack: Assets.threedJupiter,
    name: 'Jupiter',
    color: Colors.brown,
    diameter: 1.7,
    moons: [],
    ...
    imgAssetPath: Assets.imagesJupiter,
    vidAssetPath: Assets.assetsThreedJupiter,
  ),
  Planet(
    imgBack: Assets.threedSaturn,
    name: 'Saturn',
    color: Colors.lime,
    diameter: 1.55,
    moons: [],
    ...
    imgAssetPath: Assets.imagesSaturn,
    vidAssetPath: Assets.assetsThreedSaturn,
  ),
  Planet(
    imgBack: Assets.threedUranus,
    name: 'Uranus',
    color: Colors.teal,
    diameter: 1.3,
    moons: [],
    ...
    imgAssetPath: Assets.imagesUranus,
    vidAssetPath: Assets.assetsThreedUranus,
  ),
  Planet(
    imgBack: Assets.threedNeptune,
    name: 'Neptune',
    ...
    imgAssetPath: Assets.imagesNeptune,
    vidAssetPath: Assets.assetsThreedNeptune,
  ),
];
