...
import 'part1/app_title.dart';
import 'part1/button.dart';
import 'part1/planet.dart';
import 'part1/planet_name.dart';
import 'part2/zone_list.dart';
import 'part3/zone_detail.dart';
import 'planet_glow.dart';
import 'planet_glow_gradient.dart';

class HomeAnimation extends StatefulWidget {
  const HomeAnimation({Key? key, required this.planetData}) : super(key: key);
final Planet planetData;
  @override
  State<HomeAnimation> createState() => _HomeAnimationState();
}

class _HomeAnimationState extends State<HomeAnimation> with TickerProviderStateMixin {
          ...
          children: [
            ...
            Transform.scale(
                ...
                child: Transform.translate(
                    ...
                    child:  PlanetName(planetName: widget.planetData.name,))),
            Transform.translate(
              ...
              child: Transform.scale(
                ...
                child: Transform.scale(
                  ...
                  child: Transform.translate(
                      offset: Offset(8, -variableValue * (size.height) * 0.34),
                      child: PlanetWidget(
                        imagePath: widget.planetData.imgAssetPath,
